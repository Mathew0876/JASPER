<nav x-data="{ open: false }" class="bg-jasper-purple">
    ...
    <div class="mx-auto">
        <div class="flex justify-between">
            ...
            <div class="relative m-auto mr-2 ml-4 text-gray-600 justify-left">
                ...
                <button type="submit" class="absolute right-0 top-0 mt-3 mr-4">
                    <svg class="text-gray-600 h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 56.966 56.966" style="enable-background:new 0 0 56.966 56.966;" xml:space="preserve" width="512px" height="512px">
                        <path d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23  s10.318,23,23,23c4.761,0,9.298-1.436,13.177-4.162l13.661,14.208c0.571,0.593,1.339,0.92,2.162,0.92  
            ...
            <div class="relative m-auto ml-2 text-gray-600">
                <a href="/add">
            ...
            <div class="sm:flex sm:items-center sm:ml-6">
                <div class="h-16 w-16 m-2">
                    <img class="h-full w-full rounded-full mx-auto" src="https://tflcar.com/wp-content/uploads/2017/03/Featured-Image.jpg" alt="profile woman" />
                </div>
